...
int main(int argc, char *argv[])
{
    ...
    "  Input->Use Camera: Removes media file and resumes live camera feed.\n"
    ...
    "  The stop command halts active microphone recording.\n\n"
    "Buttons:\n"
    ...
    " Input->Use Microphone: Load the microphone device\n"
    "Common Mode Buttons:\n"
